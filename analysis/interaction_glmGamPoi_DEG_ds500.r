...
# Load data
cat("Loading data...\n")
counts <- readMM("/data/rudensky/EYW/SIG07/scanpy_outs/SIG07_doublets_CR_RNA_ds500_counts.mtx")
genes <- read_csv("/data/rudensky/EYW/SIG07/scanpy_outs/SIG07_doublets_CR_RNA_ds500_obs_genes.csv")
cells <- read_csv("/data/rudensky/EYW/SIG07/scanpy_outs/SIG07_doublets_CR_RNA_ds500_obs_cells.csv")
obs <- read_csv("/data/rudensky/EYW/SIG07/scanpy_outs/SIG07_doublets_CR_RNA_ds500_obs.csv")
degSig <- read_csv("/data/rudensky/EYW/git_projects/SIG07/analysis_outs/deg_sig_wilcoxon_ds500.csv")
...
write_csv(interaction_de_results, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_interaction_ds500_deg.csv")
write_csv(single_de_results, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_singles_ds500_deg.csv")
write_csv(all_coefficients, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_coefficients_ds500.csv")
