...
write_csv(interaction_de_results, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_interaction_lfc_allGenes.csv")
write_csv(single_de_results, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_singles_lfc_allGenes.csv")
write_csv(all_coefficients, "/data/rudensky/EYW/git_projects/SIG07/analysis_outs/glmGamPoi_coefficients_allGenes.csv")
